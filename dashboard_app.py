...
def connect_gsheets():
    ...
    creds = dict(st.secrets["gcp_creds"])
    sa = gspread.service_account_from_dict(creds)
    spreadsheet = sa.open("Historico_Backlog")
    return spreadsheet.worksheet("Página1") # O nome padrão da primeira aba é "Página1" ou "Sheet1"

def update_history(worksheet, total_chamados):
    """Adiciona o total de hoje à planilha, se já não houver sido adicionado."""
...
def get_history(worksheet):
    """Lê todos os dados da planilha e retorna como um dataframe."""
