            ...
            with st.spinner("Salvando arquivo de fechados e atualizando snapshot diário..."):
                ...
                try:
                    ...
                    if not df_historico_base.empty:
                        # Garante que o histórico use a mesma coluna de ID que 'df_atual_base'
                    ...
                    # <<< CORREÇÃO InvalidIndexError >>> Atualiza o universo em vez de concatenar
                    ...
                    # Remove duplicatas finais por segurança
                    df_universo = df_universo.drop_duplicates(subset=[id_col_atual], keep='last')
                    
                    # Salva o histórico MESTRE (somente os com data de fechamento)
                    ...
                    # Salva o snapshot diário (somente os SEM data de fechamento)
                    ...
                    # Salva o 'dados_atuais.csv' (somente os abertos)
...
try:
    ...
    # <<< CORREÇÃO >>> df_abertos é o df_atual. O filtro já foi feito no upload.
    df_abertos = df_atual
