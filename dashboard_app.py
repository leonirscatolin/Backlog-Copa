...
gif_base_64 = get_base_64_of_bin_file(gif_path)
belago_logo_base64 = get_base_64_of_bin_file(belago_logo_path)
if gif_base_64 and belago_logo_base64:
    st.sidebar.markdown(
        f"""
        <div style="text-align: center;">
            <img src="data:image/gif;base64,{gif_base_64}" alt="Logo Copa Energia" style="width: 100%; border-radius: 15px; margin-bottom: 20px;">
    ...
    try:
        ...
        with tab2:
            ...
            if not df_aging.empty:
                ...
                st.warning("Esta funcionalidade está em manutenção para garantir a estabilidade do aplicativo.")
            else:
